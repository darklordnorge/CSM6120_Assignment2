...
This will be done algorithm for algorithm, with a large table showing all the results which can be found in appendix \textbf{ADD APPENDIX WITH RESULT TABLE}\\
...
\hline
\bfseries Test case & \bfseries Manhattan Distance& \bfseries Patch cost & \bfseries Expanded nodes & \bfseries Running Time \\
 & & &\bfseries in nanosecond\\\hline
1 & 2 & 2 & & 6 \\
2 & 4 & 4 & & 7 \\
3 & 6 & 21 & & 11\\\hline 
